...
fun Application.configureCommentsRouting() {
    ...
    suspend fun canModifyComment(comment: Int, userId: Int): Boolean {
        // TODO: Admins can modify any comment
        return service.isOwner(comment, userId)
    }
        ...
        authenticate {
            ...
            put("/comments/{id}", {
                ...
                service.dbQuery {
                    ...
                    update =
                        if (comment.addedOn.plus(Duration.ofMinutes(5)).isBefore(Instant.now())) {
